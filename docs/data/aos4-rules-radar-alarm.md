...
| 2026-09-23 | Krong the Club intake (issue #1999), no radar event; BSData `Regiments of Renown.cat` pinned at `main` `8836d9f9` (blob unchanged at the later `main` head `d1f97bc9`) | First Regiment of Renown shipped from BSData: a bounded extract takes only Krong's two abilities from the catalogue (both match the official Regiments of Renown - Sons of Behemat pack, page 5, word for word), and the official Battle Profiles - Sons of Behemat row supplies its 140 points, 24 inclusion factions, and the single Mancrusher Gargant member; the BSData member link is a fail-closed cross-check and the game-system force-entry conditions are not read. The Wahapedia Krong watch became a duplicate-source sentinel. `bsData.baselineSha` stays held at `d989a15e` for the official September 2026 intake; corpus 2026-09-23 |
