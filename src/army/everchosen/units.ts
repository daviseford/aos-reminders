  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        ...
        desc: `Casting value equal to the bravery of target unit within 9" of caster. Roll a number of dice equal to the units bravery. It suffers 1 mortal wound for each 4+.`,
        when: [HERO_PHASE],
        spell: true,
      },
    ],
