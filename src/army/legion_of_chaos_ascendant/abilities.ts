...
const Abilities: TAbilities = [
  ...
  },
  {
    ...
    desc: `Pick 1 friendly Chaos Ascendant Daemon hero that is on the battlefield and roll 3D6. On a 10+ you can summon a 10 man unit of either Bloodletters, Plaguebearers, Daemonettes, or Pink Horrors. - Tzeentch Hero: 5 Horrors of Tzeentch. The unit's god keyword must match a god keyword from the summoning hero. The summoned unit must be setup within 12" of the hero and more than 9" from enemy units.
