...
const Abilities: TAbilities = [
  ...
  },
  {
    ...
    desc: `You can use this command ability once per battle at the start of your combat phase if your general is still alive. Count up all the units that are wholly within 18" of your general and roll a die and add the units and dice result together. On an 11 or lower all friendly Bonesplitters units wholly within range of the general get +1 to their attacks, if the roll is 12 or more then add +2 to their attacks instead.`,
