...
const Spells: TSpells = [
  ...
  },
  {
    ...
    effects: [
      ...
      {
        name: `Black Hunger`,
        desc: `Add 1 to the Attacks characteristic of any melee weapons used by the chosen unit until your next hero phase.`,
        when: [COMBAT_PHASE],
      },
    ],
  },
  ...
  },
  {
    ...
    effects: [
      ...
      {
        name: `Ferocious Hunger`,
        desc: `Add the D3 roll to the Attacks characteristic of melee weapons used by that unit.`,
        when: [COMBAT_PHASE],
      },
    ],
  },
  {
    ...
    effects: [
      ...
      {
        name: `Malefic Hunger`,
        desc: `You can re-roll wound rolls for attacks made with melee weapons by friendly Flesh-eater Courts units wholly within 16" of the caster.`,
        when: [COMBAT_PHASE],
      },
    ],
  },
