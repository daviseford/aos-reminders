    ...
    effects: [
      {
        name: 'Babbling Wand',
        desc:
          'If Skragrott is your general and is on the battlefield at the start of your hero phase, roll a dice. On a 4+ you receive D3 extra command points.',
    ...
    effects: [
      {
        ...
        desc:
          'Once per battle, in your hero phase, you can say that this Loonboss on Mangler Squigs is eating a redcap mushroom. If you do so, until your next hero phase, you can re-roll hit and wound rolls for this model (but not for the model’s mount or crew).',
        when: HERO_PHASE,
      },
      {
        name: 'Watch out!',
    ...
    effects: [
      {
        ...
        desc:
          'Once per battle, in your hero phase, you can attempt to cast one additional spell with a Madcap Shaman. If you do so, and the casting roll is a double, this model suffers D3 mortal wounds after the effects of the spell (if any) have been resolved.',
        when: HERO_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc:
          'If the Fungoid Cave-Shaman is on the battlefield at the start of your hero phase, roll a dice. On a 4+ you receive 1 extra command point.',
        when: START_OF_HERO_PHASE,
      },
      {
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        name: 'Bogeyman',
        desc:
          'You can make a Gobbapalooza Know-wotz roll for a Scaremonger. If you do so, roll a dice. On a 3+ pick 1 friendly MOONCLAN GROT unit wholly within 18" of this model that is visible to them. You can re-roll charge rolls and run rolls for that unit until your next hero phase.',
        when: HERO_PHASE,
      },
      {
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        ...
        desc:
          'You can make a Gobbapalooza Know-wotz roll for a Brewgit. If you do so, roll a dice. On a 3+ pick 1 friendly MOONCLAN GROT HERO within 18" of this model that is visible to them. You can re-roll hit rolls for that HERO until your next hero phase.',
        when: HERO_PHASE,
      },
      {
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        name: 'Poison Brewer',
        desc:
          'You can make a Gobbapalooza Know-wotz roll for a Spiker. If you do so, roll a dice. On a 3+ pick 1 friendly MOONCLAN GROT unit wholly within 18" of this model that is visible to them. You can re-roll wound rolls of 1 for that unit until your next hero phase.',
        when: HERO_PHASE,
      },
      {
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        name: 'Regeneration',
        desc:
          'In your hero phase, you can roll a dice for a Dankhold Troggboss. If you do so, on a 4+ heal up to D3 wounds allocated to this unit.',
        when: HERO_PHASE,
      },
      {
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        name: 'Regeneration',
        desc:
          'In your hero phase, you can roll a dice for a Mollog. If you do so, on a 4+ heal up to D3 wounds allocated to this unit.',
        when: HERO_PHASE,
      },
      {
      ...
      },
      {
        ...
        desc:
          'At the start of the combat phase, you can pick 1 enemy unit within 3" of this Mollog and roll a dice. On a 5+ subtract 1 from hit rolls for attacks made by that unit in that combat phase. This ability cannot be used if the Spiteshroom minion has been removed before the start of that combat phase.',
        when: START_OF_COMBAT_PHASE,
      },
      {
    ...
    effects: [
      {
        name: 'Regeneration',
        desc:
          'In your hero phase, you can roll a dice for Fellwater Troggoths. If you do so, on a 4+ heal up to D3 wounds allocated to this unit.',
        when: HERO_PHASE,
      },
      {
    ...
    effects: [
      {
        name: 'Regeneration',
        desc:
          'In your hero phase, you can roll a dice for Rockgut Troggoths. If you do so, on a 4+ heal up to D3 wounds allocated to this unit.',
        when: HERO_PHASE,
      },
      {
        name: 'Stony Skin',
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        name: 'Regeneration',
        desc:
          'In your hero phase, you can roll a dice for Dankhold Troggoths. If you do so, on a 4+ heal up to D3 wounds allocated to this unit.',
        when: HERO_PHASE,
      },
      {
        name: 'Squiggly-beast Followers',
