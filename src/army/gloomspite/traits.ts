    ...
    effects: [
      {
        name: 'The Clammy Hand',
        desc:
          'If this general is within 12" of a Bad Moon Loonshrine at the start of your hero phase, you can use the Bad Moon Loonshrine’s ‘Moonclan Lair’ scenery rule 2 times in that hero phase.',
