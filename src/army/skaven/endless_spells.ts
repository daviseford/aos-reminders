...
const EndlessSpells: TEndlessSpells = [
  ...
  },
  {
    ...
    effects: [
      ...
      {
        name: `Summon`,
        desc: `Casting value of 7. Only Skaventide wizards can attempt to cast this spell. Set up 1 of these models wholly within 13" of the caster.`,
        when: [HERO_PHASE],
      },
      {
        name: `Ravening Horde`,
  ...
  },
  {
    ...
    effects: [
      ...
      {
        name: `Summon`,
        desc: `Casting value of 6. Only Skaventide wizards can attempt to cast this spell. Set up 1 of these models wholly within 13" of the caster.`,
        when: [HERO_PHASE],
      },
      {
