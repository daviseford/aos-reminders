    ...
    effects: [
      {
        name: 'Hammerblade (Destruction)',
        desc:
          'Pick one of the bearer’s melee weapons. Instead of attacking normally with that weapon, you can roll a dice for each model within 3" of the bearer (apart from the bearer). On 5 or 6, 1 mortal wond is inflicted on that model’s unit.',
        when: COMBAT_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Bellowing Blade (Destruction)',
        desc:
          'When the bearer is picked to fight, you can re-roll one wound roll for the bearer’s attack in that fight for each enemy HERO that was within 12" of the bearer when they were picked to fight.',
        when: COMBAT_PHASE,
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Collar of Domination (Destruction)',
        desc:
          'At the start of your opponent’s movement phase, pick an enemy MONSTER within 3" of the bearer and roll 2D6. If the roll is equal or greater than enemy monsterbs Bravery characteristic, it must retreat in that movement phase',
        when: MOVEMENT_PHASE,
      },
    ],
  },
