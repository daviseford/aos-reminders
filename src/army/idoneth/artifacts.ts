    ...
    effects: [
      {
        name: 'Ankusha Spu',
        desc:
          'Add 3" to the bearer’s Move characteristic. In addition, re-roll hit rolls of 1 for attacks made by the bearer’s mount.',
    ...
    effects: [
      {
        name: 'Dritchleech',
        desc:
          'Subtract 1 from the casting rolls of WIZARDS while they are within 18" of the bearer. IDONETH DEEPKINWIZARDS are not affected by this artefact.',
        when: [HERO_PHASE],
      },
    ],
  },
