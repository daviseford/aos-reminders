...
export const Units: TUnits = [
  {
    ...
    effects: [
      ...
      },
      {
        ...
        desc:
          'At the start of the combat phase, you can pick an enemy HERO with a Wounds characteristic of less than 8 that is within 3" of this model. Subtract 1 from hit rolls for that HERO for the rest of that combat phase.',
    ...
    effects: [
      {
        ...
        desc:
          'You can re-roll one casting roll for this model in each of your hero phases. If you do not re-roll a casting roll, then you can heal D3 wounds allocated to this model at the end of your hero phase instead.',
        when: [HERO_PHASE],
      },
      {
        name: 'Tranquility of the Abyss',
        desc:
          'Add 3 to the Bravery characteristic of friendly IDONETH DEEPKIN units while they are within 9" of this model.',
        when: [DURING_GAME],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc:
          'At the start of your charge phase, if this unit is within 12" of any enemy models that have been allocated any wounds, you can re-roll charge rolls for this unit in that charge phase.',
        when: [START_OF_CHARGE_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Jaws of Death',
        desc:
          'Each time you make a hit roll of 6+ for this model’s Leviadon’s Crushing Jaws attack, that attack inflicts 6 mortal wounds instead of the normal damage.',
        when: [COMBAT_PHASE],
      },
      {
        name: 'Void Drum',
        desc:
          'IDONETH DEEPKIN units are treated as being in cover while they are wholly within 12" of any friendly Akhelian Leviadons',
        when: [DURING_GAME],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc:
          'If your army has the IDONETH DEEPKIN allegiance and includes this battalion, then once per battle at the start of a battle round, you can choose to use the High Tide ability from the Tides of Death table for that battle round instead of the ability that would normally be used.',
        when: [START_OF_ROUND],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc:
          'SYLVANETH units from this battalion have the Tides of Death battle trait, and gain abilities from the Tides of Death table in the same manner as IDONETH DEEPKIN units.',
        when: [DURING_GAME],
      },
    ],
  },
