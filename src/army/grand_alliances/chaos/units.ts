...
import { HERO_PHASE, DURING_SETUP, DURING_GAME, COMBAT_PHASE, CHARGE_PHASE } from 'types/phases'
    ...
    effects: [
      {
        ...
        desc: `By carving runes of domination into a Slaughterbrute's back and driving daggers of binding into its flesh, the monster's will can be bound to a Champion of Chaos. When you set up a Slaughterbrute, you can pick a Slavesto Darkness Hero in your army to be its master (a model cannot be the master of more than one Slaughterbrute – the effort required would be fatal). As long as the Slaughterbrute's master is on the battlefield, the Slaughterbrute's melee weapons hit on rolls of 3+ rather than 4+.`,
        when: [DURING_SETUP, COMBAT_PHASE],
      },
      {
        name: `Beast Unbound`,
        desc: `A Slaughterbrute without a master is a terrifying force of destruction, running rampant and attacking anything that comes near. If a Slaughterbrute does not have a master on the battlefield in the charge phase, roll a dice. If the result is 3 or less it lashes out in a wild berserk fury at the nearest model, friend or foe, within 3". That model's unit immediately suffers D3 mortal wounds.`,
        when: [CHARGE_PHASE],
      },
    ],
  },
