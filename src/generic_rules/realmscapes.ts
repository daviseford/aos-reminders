...
import { DURING_GAME, HERO_PHASE, START_OF_HERO_PHASE, START_OF_ROUND } from 'types/phases'
    ...
    effects: [
      {
        ...
        desc: `WIZARD HEROES with a Wounds characteristic of 9 or less that are not Unique gain the ANDTORIAN LOCUS keyword.`,
        when: [DURING_GAME],
