...
const CoreRules: TEntry[] = [
...

  {
    name: 'Battle Tactics',
    effects: [
      // TODO: These should be enabled when GHUR is selected
      // {
      //   name: `Battle Tactics`,
      ...
      // TODO: These should only be enabled when Gallet is selected
      {
      ...
      {
        name: `Barge Through Enemy Lines`,
