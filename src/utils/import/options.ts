...
export const importFactionNameMap = {
  ...
  'Big Waaagh!': ORRUK_WARCLANS,
  'Blades of Khorne': KHORNE,
  'Cities of Sigmar': CITIES_OF_SIGMAR,
  'Clans Eshin': SKAVENTIDE,
  'Clans Moulder': SKAVENTIDE,
  'Clans Pestilens': SKAVENTIDE,
  'Clans Skryre': SKAVENTIDE,
  'Clans Verminus': SKAVENTIDE,
  ...
  'Legion of Azgorh': LEGION_OF_AZGORH,
  'Legion of Blood': LEGIONS_OF_NAGASH,
  'Legion of Chaos Ascendant': LEGION_OF_CHAOS_ASCENDANT,
  'Legion of Grief': LEGION_OF_GRIEF,
  'Legion of Night': LEGIONS_OF_NAGASH,
  'Legion of Sacrament': LEGIONS_OF_NAGASH,
  ...
  Ironjawz: ORRUK_WARCLANS,
  Khorne: KHORNE,
  Lethisian: LETHISIAN_DEFENDERS,
  Lumineth: LUMINETH_REALMLORDS,
