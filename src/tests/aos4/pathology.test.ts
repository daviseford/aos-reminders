...
describe('AoS 4 structured-data pathology validation', () => {
  ...
  it('binds the Lord-Terminos correction to official page evidence', () => {
    expect(AOS4_GOLDEN_TRUTH_CASES).toContainEqual({
      ...
      rationale:
        'The July 2026 official base-size cell was layout-split (2 5 m m [1]); the September 2026 re-publication prints it as one 25mm [1] token, and the golden value keeps guarding the second Lord-Terminos base size.',
    })
  })
