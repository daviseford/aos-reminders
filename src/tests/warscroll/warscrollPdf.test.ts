...
describe('getWarscrollArmyFromPdf', () => {
  ...
  it('correctly imports the Fateskimmer and his warscroll spell', () => {
    ...
    expect(warscrollTxt.selections).toEqual({
      ...
      endless_spells: [],
      scenery: [],
      spells: ['Bolt of Tzeentch', "Tzeentch's Firestorm (Fateskimmer)"],
      traits: [],
      triumphs: [],
  ...
  it('correctly imports the Fateskimmer when he has both Firestorm spells', () => {
    ...
    expect(warscrollTxt.selections).toEqual({
      ...
      endless_spells: [],
      scenery: [],
      spells: ["Tzeentch's Firestorm (Lore of Change)", "Tzeentch's Firestorm (Fateskimmer)"],
      traits: [],
      triumphs: [],
      units: ['Fateskimmer, Herald of Tzeentch on Burning Chariot'],
    })
  ...
  it('correctly imports the Firestorm lore spell', () => {
    ...
    expect(warscrollTxt.selections).toEqual({
      ...
      endless_spells: [],
      scenery: [],
      spells: ["Tzeentch's Firestorm (Lore of Change)", 'Infernal Flames'],
      traits: [],
      triumphs: [],
