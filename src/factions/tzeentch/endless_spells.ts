...
import { END_OF_HERO_PHASE, END_OF_MOVEMENT_PHASE, HERO_PHASE } from 'types/phases'
import Spells from './spells'

// Endless prayers.
const EndlessSpells = {
  'Daemonic Simulacrum (Tzeentch)': {
    effects: [
      {
      ...
      {
        name: `Predatory`,
        desc: `A Daemonic Simulacrum is a predatory endless spell. It can move up to 9" and can fly.`,
  ...
  'Tome of Eyes (Tzeentch)': {
    ...
    effects: [
      ...
      },
      {
        ...
        desc: `If the Tome of Eyes is on the battlefield, you can reroll casting rolls for the caster.
  ...
  'Burning Sigil of Tzeentch (Tzeentch)': {
    effects: [
      {
