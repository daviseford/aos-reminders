  ...
  Herdstone: {
    effects: [
      ...
      },
      {
        ...
        If a friendly BEASTS OF CHAOS unit wholly within range of this terrain feature fails a battleshock test, halve the number of models that flee from that unit (rounding down). In addition, if a friendly BEASTS OF CHAOS unit wholly within range of this terrain feature receives the Rally command, you can return 1 slain model to that unit for each 4+ instead of each 6.`,
