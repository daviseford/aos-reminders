    ...
    effects: [
      {
        ...
        desc:
          'You can reroll hit and wound rolls for attacks made with melee weapons by this general that target an enemy HERO with an artefact of power.',
        when: ['DURING_COMBAT_PHASE'],
      },
    ],
  },
  'Crushing Bulk': {
    ...
    effects: [
      {
        ...
        when: ['DURING_SHOOTING_PHASE', 'DURING_COMBAT_PHASE'],
      },
    ],
  },
    ...
    effects: [
      {
        name: 'Nomadic Raider',
        desc:
          'You can reroll wound rolls for attacks made with melee weapons by this general (including their mount) while this general is wholly within enemy territory.',
        when: ['DURING_COMBAT_PHASE'],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        when: ['DURING_COMBAT_PHASE', 'DURING_SHOOTING_PHASE'],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc:
          'You can reroll 1 wound roll for 1 attack made with 1 melee weapon each time this model attacks. In addition, you can reroll wound rolls for attacks made with melee weapons by this model that target a unit that is part of a garrison.',
        when: ['DURING_COMBAT_PHASE'],
      },
    ],
  },
