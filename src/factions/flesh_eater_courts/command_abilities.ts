...
const CommandAbilities = {
  ...
  'Feeding Frenzy': {
    effects: [
      {
        name: `Feeding Frenzy`,
        desc: `You can use this command ability in the combat phase after a friendly FLESH-EATER COURTS unit has fought for the first time in that phase and is wholly within 12" of a friendly FLESH-EATER COURTS HERO or wholly within 18" of a friendly FLESH-EATER COURTS HERO that is a general. If you do so, that unit can immediately make a pile-in move and then attack with all of the melee weapons it is armed with for a second time. You cannot pick the same unit to benefit from this ability more than once per phase.`,
        when: [COMBAT_PHASE],
        rule_sources: [
