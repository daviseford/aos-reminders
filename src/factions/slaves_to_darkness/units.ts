...
const Units = {
  'Archaon the Everchosen': {
    ...
    effects: [
      ...
      {
        name: `Filth-spewer`,
        desc: `Pick 1 enemy unit within 6" of this unit and roll a number of dice equal to the number of models in that unit (to a maximum of 7). For each 3+, that unit suffers 1 mortal wound.`,
        when: [END_OF_CHARGE_PHASE],
      },
      {
        name: `Skull-gorger`,
        desc: `Pick 1 enemy model within 3" ot this unit and roll a dice. If the roll is greater than that model's Wounds characteristic, it is slain and you can heal a number of wounds allocated to this unit equal to that enemy model's Wounds characteristic.`,
        when: [END_OF_CHARGE_PHASE],
      },
      {
        name: `Spell-eater`,
        desc: `Pick 1 endless spell within 12" of this unit and roll a dice, On a 2+, that endless spell is dispelled and if the caster is on the battlefield they suffer D3 mortal wounds.`,
        when: [END_OF_CHARGE_PHASE],
      },
    ],
  },
