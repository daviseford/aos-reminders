...
const Units = {
  ...
  'Spoilpox Scrivener, Herald of Nurgle': {
    effects: [
      DisgustinglyResilientEffect,
      {
        ...
        desc: `Select 1 friendly Plaguebearer unit wholly within 14" of this model and pick a count to last until the end of the phase. A unit cannot carry out more than 1 count per phase.`,
        when: [START_OF_COMBAT_PHASE],
      },
      {
        name: `Tally of Blows (Count)`,
        desc: `Add 1 to the attacks characteristic of the buffed unit.`,
        when: [COMBAT_PHASE],
      },
      {
        name: `Studied Lacerations (Count)`,
        desc: `Improve the rend characteristic of the buffed unit by 1.`,
        when: [COMBAT_PHASE],
      },
      {
        name: `Recorded Stamina (Count)`,
        desc: `Add 1 to the save rolls of the buffed unit.`,
        when: [SAVES_PHASE],
      },
    ],
  },
  'Sloppity Bilepiper, Herald of Nurgle': {
    effects: [
      DisgustinglyResilientEffect,
      {
        ...
        desc: `Add 1 to the bravery characteristic of friendly Nurgle Daemon units while they are wholly within 14" of any Sloppity Bilepipers.`,
        when: [DURING_GAME],
      },
      {
        name: `Jolly Gutpipes`,
        desc: `Pick 1 tune to last until the end of the phase. A unit cannot benefit from a tune more than once per phase. If a unit would be affected by 2 or more different tunes, none of the tunes have an effect.`,
        when: [START_OF_COMBAT_PHASE],
      },
      {
        name: `A Stabbing We Will Go! (Tune)`,
        desc: `Add 1 to the melee attacks characterisitc of friendly Nurgle Daemon units wholly within 14" of any friendly Sloppity Bilepipers playing this tune.`,
        when: [COMBAT_PHASE],
      },
      {
      ...
      },
      {
        ...
        desc: `Enemy models within 3" of friendly Nurgle Daemon units wholly within 14" of any friendly Sloppity Bilepipers playing this turn cannot finish pile-in moves closer than they started to the buffed unit.`,
        when: [COMBAT_PHASE],
      },
    ],
  },
  ...
  'Beasts of Nurgle': {
    effects: [
      DisgustinglyResilientEffect,
      {
        name: `Acid Slime Trails`,
        desc: `Roll a D6 for each enemy unit within 3" of this model immediately before this unit makes a retreat move. On a 4+ that enemy unit suffers D3 mortal wounds.`,
        when: [MOVEMENT_PHASE],
      },
      {
        name: `Attention Seekers`,
        desc: `This unit can charge in the same turn in which it ran or retreated. When this unit retreats it can pass across other models as though flying.`,
        when: [MOVEMENT_PHASE, CHARGE_PHASE],
      },
      {
        name: `Pestilent Battering Rams`,
        desc: `After each model in this unit finishes a charge move, roll a D6 for each enemy unit within 1" of that model. On a 2+ the enemy unit suffers D3 mortal wounds. Do not allocate wounds until this entire unit finishes its charge.`,
        when: [CHARGE_PHASE],
      },
    ],
  },
