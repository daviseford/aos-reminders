...
const Spells = {
    ...
    effects: [
      {
        ...
        desc: `Stream of Corruption is a spell with a casting value of 6 and a range of 7". If successfully cast, pick 1 enemy unit within range and visible to the caster. Roll 1 dice for each model in that unit that is within range of the caster. For each 5+, that unit suffers 1 mortal wound.
  ...
  'Plague Wind': {
    effects: [
      {
        name: `Plague Wind`,
        desc: `Casting value of 7 and a range of 14". If successfully cast, pick 1 point on the battlefield within range and visible to the caster and draw a straight line between that point and the closest part on the caster's base. Roll a dice for each enemy unit passed across by that line. On a 4+, that unit suffers 1 disease point.`,
        when: [HERO_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc: `Casting value of 6 and a range of 14". If successfully cast, pick 1 enemy unit within range and visible to the caster. Until your next hero phase, roll a dice at the end of each phase in which any wounds or mortal wounds were allocated to that unit. On a 2+, that unit suffers D3 mortal wounds.`,
        when: [HERO_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc: `Casting value of 7 and a range of 14". If successfully cast, pick 1 enemy unit within range and visible to the caster. Subtract 1 from save rolls for attacks that target that unit for the rest of the battle. The same unit cannot be affected by this spell more than once.`,
        when: [HERO_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc: `Abundance of Flesh is a spell that has a casting value of 6 and a range of 14". If successfully cast, pick 1 friendly Maggotkin of Nurgle Mortal unit within range and visible to the caster. Add 1 to the Wounds characteristic of that unit until your next hero phase.
