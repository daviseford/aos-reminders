...
const CommandAbilities = {
  ...
  //       when: [COMBAT_PHASE],
  //       rule_sources: [rule_sources.BATTLETOME_SERAPHON, rule_sources.ERRATA_AUGUST_2021],
  //     },
  //   ],
  // },
  ...
  //       when: [START_OF_COMBAT_PHASE],
  //       rule_sources: [rule_sources.BATTLETOME_SERAPHON, rule_sources.ERRATA_JANUARY_2021],
  //     },
  //   ],
  // },
  // 'Coordinated Strike': {
