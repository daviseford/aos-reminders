    ...
    effects: [
      {
        ...
        desc: `Casting value of 6 and a range of 18". If cast, pick 1 enemy unit within range and visible to the caster. Until your next hero phase, halve run rolls and charge rolls for that unit.`,
        when: [HERO_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc: `Casting value of 7 and a range of 12". If cast, pick 1 enemy model within range that is visible to the caster and roll a dice. If the dice roll is greater than that model's Wounds characteristic, it is slain.`,
        when: [HERO_PHASE],
      },
    ],
  },
    ...
    effects: [
      {
        ...
        desc: `Casting value of 6 and a range of 12". If cast, pick 1 enemy unit within range and visible to the caster. Worsen the Rend characteristic of that unit's melee weapons by 1 until your next hero phase.`,
        when: [HERO_PHASE],
      },
    ],
  },
