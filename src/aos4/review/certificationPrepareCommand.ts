...
const EXISTING_INPUTS = {
  'accepted-manifest': path.join('data', 'aos4', 'manifests', 'accepted-2026-08-01.json'),
  'corpus-review': path.join('data', 'aos4', 'reviews', 'corpus-2026-08-01.json'),
  'audit-catalog': path.join('data', 'aos4', 'catalog', 'catalog.json'),
  'reconciliation-report': path.join('data', 'aos4', 'reports', 'corpus-2026-08-01-reconciliation.json'),
