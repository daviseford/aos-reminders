...
const EXISTING_INPUTS = {
  ...
  'corpus-review': path.join('data', 'aos4', 'reviews', 'corpus-2026-08-01d.json'),
  'audit-catalog': path.join('data', 'aos4', 'catalog', 'catalog.json'),
  'reconciliation-report': path.join('data', 'aos4', 'reports', 'corpus-2026-08-01d-reconciliation.json'),
