 ...
 */
export const ACCEPTED_MANIFEST_PATH = path.join('data', 'aos4', 'manifests', 'accepted-2026-09-23.json')
export const ACCEPTED_REVIEW_PATH = path.join('data', 'aos4', 'reviews', 'corpus-2026-09-23.json')
export const ACCEPTED_SUMMARY_REPORT_PATH = path.join(
  'data',
  'aos4',
  'reports',
  'corpus-2026-09-23-summary.json'
)
export const ACCEPTED_RECONCILIATION_REPORT_PATH = path.join(
  'data',
  'aos4',
  'reports',
  'corpus-2026-09-23-reconciliation.json'
)
...
export const ACCEPTED_RECONCILIATION_REPORT_DESTINATION =
  'data/aos4/reports/corpus-2026-09-23-reconciliation.json'
