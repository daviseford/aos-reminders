...
- **The accepted corpus** `aos4-corpus-2026-09-23`: 28 decoded source factions (27 playable armies
  plus the Endless Spells container), 1,300 warscrolls, 1,016 battle profiles, 5,123 abilities,
  2,269 weapons, 1,507 content groups, and 20,198 live source records. Checked in under
  `src/aos4/generated/corpus/`.
- **A beta certification** binding that corpus to a complete machine review — 85,064 results across
  42,532 source/generated pairs, zero live findings, zero `cannot-verify` outcomes. Verifiable
