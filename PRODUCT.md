...
- **The accepted corpus** `aos4-corpus-2026-08-18`: 28 decoded source factions (27 playable armies
...
- **A beta certification** binding that corpus to a complete machine review — 81,956 results across
  40,978 source/generated pairs, zero live findings, zero `cannot-verify` outcomes. Verifiable
