...
- the checked-in runtime is generated from the accepted `aos4-corpus-2026-08-28` snapshot
...
The accepted `aos4-corpus-2026-08-28` snapshot is complete and machine-audited. The manifest, corpus
